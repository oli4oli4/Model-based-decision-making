...
def get_model_for_problem_formulation(problem_formulation_id):
    ...
    # OWN PROBLEM FORMULATION:
        ...
        function.gelderland_dikelist = function.dikelist[:-2] #Cut the dikelist by removing the last two dike rings
...
#             variable_names_3.extend(['Expected Evacuation Costs {}'.format(n)])
        ...
        for n in function.planning_steps:
            for dike in function.ring12_dikelist:
                variable_names_11.extend(['{}_Expected Annual Damage {}'.format(dike, n)])
                variable_names_12.extend(['{}_Expected Number of Deaths {}'.format(dike, n)])
            for dike in function.ring3_dikelist:
                variable_names_13.extend(['{}_Expected Annual Damage {}'.format(dike, n)])
                variable_names_14.extend(['{}_Expected Number of Deaths {}'.format(dike, n)])            
            for dike in function.gelderland_dikelist:
                variable_names_15.extend(['{}_Dike Investment Costs {}'.format(dike, n)])
